program ctrw_1D_ensemble_expWait_exactT
  ...
  do traj = 1, ntraj !
     ...
     do step = 1, nsteps_max !we expect a finite number of jumps (Poisson-distributed with mean λ * tmax), but nsteps_max prevents infinite loops if something goes wrong.
