...
program jerky_active_fast
  ...
  real(dp), parameter :: taup      = 1.0e-3_dp

  ! Simulation controls (lighter settings)
  integer,  parameter :: Ntraj = 10000
  real(dp), parameter :: dt_frac = 5.0d-2     ! dt = 0.00005 (≪ τp)
  real(dp), parameter :: Tmax    = 100.0_dp    ! up to 10 τI
