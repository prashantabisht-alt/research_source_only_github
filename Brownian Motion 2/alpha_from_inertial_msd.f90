!===============================================================
! Compute alpha(s) = d ln(MSD)/d ln s from a 2-col file:
!   input : "msd_persistent_norm.txt"  (s, MSD_norm)
!   output: "alpha_persistent.txt"     (s, alpha(s))
!
! Robust bits:
!  - ignores lines starting with '#'
!  - requires s>0 and MSD>0
!  - central differences in log-log, one-sided at ends
!  - optional moving-average smoothing (set SMOOTH_WIN below)
!===============================================================
