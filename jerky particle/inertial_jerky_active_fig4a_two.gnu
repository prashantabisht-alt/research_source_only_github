...
# Styles (consistent with 1e-3 case)
...
set style line 4 lc rgb "#2ca02c" dt 3 lw 2            # t^4 guide = green dash-dot
set style line 5 lc rgb "#9467bd" dt 4 lw 2            # t^3 guide = purple dotted

plot \
  "msd_active_taupratio_1e3.txt"                u 1:2 w lp ls 1 t "simulation τp=1000 τI", \
  "msd_theory_taupratio_1e3_overlay_numeric.txt" u 1:2 w  l  ls 2 t "theory τp=1000 τI", \
  0.0278*x**6   w l ls 3 t "t^6 prefactor", \
  0.25*x**4     w l ls 4 t "t^4 prefactor", \
  1333.3*x**3   w l ls 5 t "t^3 prefactor"
