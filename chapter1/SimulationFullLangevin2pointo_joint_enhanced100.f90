...
program SimulationfullLangevintwopointo
  ...
  open(unit=12, file="velocity_distributions100.txt", status='replace', action='write')
  ...
  open(unit=13, file="position_distributions100.txt", status='replace', action='write')
  ...
  open(unit=14, file="joint_distribution100.txt", status='replace', action='write')
  ...
  open(unit=15, file="phase_space_points100.txt", status='replace', action='write')
  ...
  print*, "Done. Files:"
  print*, "  velocity_distributions100.txt"
  print*, "  position_distributions100.txt"
  print*, "  joint_distribution100.txt, joint_theory100.txt"
  print*, "  axes_theta_theory100.txt, axes_theta_sim100.txt"
  print*, "  diagnostics_Tmax100.txt"
...
!  - joint_theory100.txt: theory P(x,v) on same grid as hist
!  - diagnostics_Tmax100.txt: theory vs sample stats
!  - axes_theta_theory100.txt, axes_theta_sim100.txt: two perpendicular lines each
!========================================================
subroutine write_theory_and_diagnostics(tnow, m, gamma, kBT, &
  ...
  open(newunit=u_ax_th, file="axes_theta_theory100.txt", status='replace', action='write')
  ...
  open(newunit=u_ax_si, file="axes_theta_sim100.txt", status='creplace', action='write')
  ...
  print *, "Wrote joint_theory100.txt, diagnostics_Tmax100.txt,"
  print *, "      axes_theta_theory100.txt, axes_theta_sim100.txt"
