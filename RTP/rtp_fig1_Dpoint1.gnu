...
set title "RTP on infinite line — D = 0.10"
set xlabel "x"
set ylabel "P(x,t)"
set xrange [-2.2:2.2]
set yrange [0:*]
...
# same per-time styles so colors & markers are consistent across D
...
plot \
  "fig1_D0.10.txt"        u 1:2  w p ls 101 t "t=0.2 (sim)", \
  ...
  "fig1_theory_D0.10.txt" u 1:2  w l ls 201 t "t=0.2 (theory)", \
