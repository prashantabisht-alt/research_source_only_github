...
! do outer loop - advancing time & inner loop nested in time loop for each single step it updates every particle one by one 
    ...
    open(unit=29, file="velocity_distributions.txt")
    ...
    open(unit=30, file="position_distributions.txt")
    ...
    print*, "Done. Check velocity_distributions.txt and position_distributions.txt"
